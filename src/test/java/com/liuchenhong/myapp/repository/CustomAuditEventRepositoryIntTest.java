package com.liuchenhong.myapp.repository;

import com.liuchenhong.myapp.JhipsterdantiApp;
import com.liuchenhong.myapp.config.Constants;
import com.liuchenhong.myapp.config.audit.AuditEventConverter;
import com.liuchenhong.myapp.domain.PersistentAuditEvent;
...
import static com.liuchenhong.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
